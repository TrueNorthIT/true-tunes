(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("electron-serve"), require("electron-store"), require("@svrooij/sonos"));
	else if(typeof define === 'function' && define.amd)
		define(["electron-serve", "electron-store", "@svrooij/sonos"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("electron-serve"), require("electron-store"), require("@svrooij/sonos")) : factory(root["electron-serve"], root["electron-store"], root["@svrooij/sonos"]);
		for(var i in a) (typeof exports === 'object' ? exports : root)[i] = a[i];
	}
})(global, (__WEBPACK_EXTERNAL_MODULE_electron_serve__, __WEBPACK_EXTERNAL_MODULE_electron_store__, __WEBPACK_EXTERNAL_MODULE__svrooij_sonos__) => {
...
electron__WEBPACK_IMPORTED_MODULE_1__.ipcMain.handle('search', async (event, term, searchType) => {

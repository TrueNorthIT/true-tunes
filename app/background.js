...
(async () => {
  ...
  mainWindow.setThumbarButtons([{
    tooltip: 'Previous',
    icon: electron__WEBPACK_IMPORTED_MODULE_4__.nativeImage.createFromPath(path__WEBPACK_IMPORTED_MODULE_3___default().join(__dirname, 'images/prev.png')),
    click() {
      sonosManager.Previous();
    }
  }, {
    tooltip: 'Play / Pause',
    icon: electron__WEBPACK_IMPORTED_MODULE_4__.nativeImage.createFromPath(path__WEBPACK_IMPORTED_MODULE_3___default().join(__dirname, 'images/play_pause.png')),
    click() {
      sonosManager.TogglePlayback();
    }
  }, {
    tooltip: 'Next',
    icon: electron__WEBPACK_IMPORTED_MODULE_4__.nativeImage.createFromPath(path__WEBPACK_IMPORTED_MODULE_3___default().join(__dirname, 'images/next.png')),
    click() {
      sonosManager.Next();
    }
  }]);
